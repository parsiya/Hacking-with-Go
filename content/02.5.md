...
goroutine 1 [running]:
main.main()
        Z:/Go/src/Hacking-with-Go/code/02/02-37-scan1.go:10 +0x1ae
exit status 2
```
...
```
$ go run 02-39-bufioreadbytes.go
Hello 0123456789
...
Don't worry about bytes and strings now. We will have a byte manipulation chapter.
