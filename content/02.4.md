...
## Type switch
Type switches are usually used inside functions that accept empty interfaces. We use them to determine the type of data that is inside the interface and act accordingly.
